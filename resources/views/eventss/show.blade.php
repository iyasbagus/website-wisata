                    ...
                    <div class="col-xl-6 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tampil Data Event</h4>
                            </div>
                            <div class="card-body">
                                 <form action="{{route('event.store')}}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="tgl_diselenggarakan" value="{{$event->tgl_diselenggarakan}}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nama Lokasi</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nama_lokasi" value="{{$event->lokasi->nama_lokasi}}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
