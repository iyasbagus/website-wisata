  ...
  <div class="content-body p-3">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                           <div class="card-header">{{ __('Data Wisata') }}  <a href="{{ route('wisata.create')}}" class="btn btn-primary btn-sm">Tambah Data</a></div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-striped verticle-middle table-responsive-sm">
                                        ...
                                        @php $no = 1; @endphp
                                         @foreach($wisata as $data)
                                            ...
                                            @method('DELETE')
                                            <td class="text-end">
                                        <a href="{{route('wisata.edit', $data->id)}}" class="btn btn-success btn-sm">Edit</a>
                                        <a href="{{route('wisata.show', $data->id)}}" class="btn btn-warning btn-sm">Show</a>
